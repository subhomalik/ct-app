  ...
  _createClass(LocalizedTextField, [{
    ...
    value: function render() {
      ...
      if (this.props.hintIcon) {
        process.env.NODE_ENV !== "production" ? utils.warning(typeof this.props.hint === 'string' || /*#__PURE__*/react.isValidElement(this.props.hint), 'LocalizedTextField: `hint` is required to be string or ReactNode if hintIcon is present') : void 0;
      }
      if (this.props.hideLanguageExpansionControls) {
        process.env.NODE_ENV !== "production" ? utils.warning(typeof this.props.defaultExpandLanguages !== 'boolean', 'LocalizedTextField: "defaultExpandLanguages" does not have any effect when "hideLanguageExpansionControls" is set.') : void 0;
      }
