...
const sequentialId = utils.createSequentialId('text-field-');
const sequentialErrorsId = utils.createSequentialId('text-field-error-')();
const sequentialWarningsId = utils.createSequentialId('text-field-warning-')();
  ...
  _createClass(TextField, [{
    ...
    value: function render() {
      if (!this.props.isReadOnly) {
        process.env.NODE_ENV !== "production" ? utils.warning(typeof this.props.onChange === 'function', 'TextField: `onChange` is required when field is not read only.') : void 0;
      }
      ...
      return jsxRuntime.jsx(Constraints__default["default"].Horizontal, {
        ...
        children: jsxRuntime.jsxs(Stack__default["default"], {
          ...
          }), jsxRuntime.jsx(TextInput__default["default"], _objectSpread(_objectSpread({
            id: this.state.id,
