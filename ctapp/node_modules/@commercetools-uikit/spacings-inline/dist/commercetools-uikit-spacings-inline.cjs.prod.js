 ...
 */
const getStyles = props => /*#__PURE__*/react.css("display:flex;align-items:", getAlignItem(props.alignItems), ";justify-content:", props.justifyContent, ";>*+*{margin:0 0 0 ", getMargin(props.scale), "!important;}" + ("" ), "" );
