...
const getStateStyles = (isDisabled, isActive, theme) => {
  ...
  if (isActive) {
    const baseActiveStyles = [/*#__PURE__*/react.css("color:", designSystem.designTokens.fontColorForButtonAsSecondary, ";*{fill:", designSystem.designTokens.fontColorForButtonAsSecondary, ";}border:1px solid ", designSystem.designTokens.borderColorForButtonAsSecondary, ";box-shadow:", designSystem.designTokens.shadow0, ";background-color:", designSystem.designTokens.colorSurface, ";&:focus,&:hover{background-color:", designSystem.designTokens.backgroundColorForButtonWhenActive, ";}" + ("" ), "" )];
    switch (theme) {
      case 'info':
  ...
  return /*#__PURE__*/react.css("color:", designSystem.designTokens.fontColorForButtonAsSecondary, ";*{fill:", designSystem.designTokens.fontColorForButtonAsSecondary, ";}&:not(:focus),&:not(:hover),&:not(:active){border:1px solid ", designSystem.designTokens.borderColorForButtonAsSecondary, ";}&:focus,&:hover{border:1px solid ", designSystem.designTokens.borderColorForButtonAsSecondary, ";box-shadow:", designSystem.designTokens.shadow0, ";}&:hover{background-color:", designSystem.designTokens.backgroundColorForButtonWhenHovered, ";}&:active{border:1px solid ", designSystem.designTokens.borderColorForButtonAsSecondary, ";box-shadow:", designSystem.designTokens.shadow0, ";background-color:", designSystem.designTokens.backgroundColorForButtonWhenActive, ";}" + ("" ), "" );
};
