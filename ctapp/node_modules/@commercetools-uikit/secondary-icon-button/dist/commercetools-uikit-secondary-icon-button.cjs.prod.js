...
const getDisabledStyle = () => {
  ...
  return /*#__PURE__*/react.css("&:disabled svg{fill:", designSystem.designTokens.colorNeutral60, ";}" + ("" ), "" );
};
const getColorStyle = props => {
  switch (props.color) {
    case 'solid':
      return /*#__PURE__*/react.css("& svg{fill:", designSystem.designTokens.colorSolid, ";}&:focus,&:hover svg{fill:", designSystem.designTokens.colorPrimary, ";}" + ("" ), "" );
    case 'primary':
      return /*#__PURE__*/react.css("& svg{fill:", designSystem.designTokens.colorPrimary25, ";}&:focus,&:hover svg{fill:", designSystem.designTokens.colorPrimary, ";}" + ("" ), "" );
    default:
      return /*#__PURE__*/react.css("svg{fill:", designSystem.designTokens.colorSolid, ";}" + ("" ), "" );
  }
};
var _ref = {
  name: "pl708y",
