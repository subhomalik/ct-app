...
const warnIfMissingTitle = (props, componentName) => {
  if (typeof props.title === 'string') {
    process.env.NODE_ENV !== "production" ? utils.warning(props.title.length > 0, "Invalid prop 'title' supplied to '".concat(componentName, "'. Expected it to be nonempty string, but it was empty.")) : void 0;
  }
};
const warnIfMissingContent = (props, componentName) => {
  ...
  process.env.NODE_ENV !== "production" ? utils.warning(hasContent, ['Warning: Failed prop type:', "The prop `intlMessage` is marked as required in `".concat(componentName, "`"), 'but its value is `undefined`'].join(' ')) : void 0;
  process.env.NODE_ENV !== "production" ? utils.warning(hasContent, ['Warning: Failed prop type:', "The prop `children` is marked as required in `".concat(componentName, "`"), 'but its value is `undefined`'].join(' ')) : void 0;
};
...
const Headline = props => {
  ...
  if (!HeadlineElement) {
    process.env.NODE_ENV !== "production" ? utils.warning(false, 'ui-kit/Text: You attempt to render a TextHeadline without specifying `as` prop.') : void 0;
...
Headline.propTypes = process.env.NODE_ENV !== "production" ? {
  as: _pt__default["default"].oneOf(['h1', 'h2', 'h3']),
...
const Subheadline = props => {
  ...
  if (!SubheadlineElement) {
    process.env.NODE_ENV !== "production" ? utils.warning(false, 'ui-kit/Text: You attempt to render TextSubheadline without specifying `as` prop.') : void 0;
...
Subheadline.propTypes = process.env.NODE_ENV !== "production" ? {
  as: _pt__default["default"].oneOf(['h4', 'h5']),
  truncate: _pt__default["default"].bool,
  nowrap: _pt__default["default"].bool,
...
Wrap.propTypes = process.env.NODE_ENV !== "production" ? {
  id: _pt__default["default"].string,
  intlMessage: _pt__default["default"].oneOfType([_pt__default["default"].any, _pt__default["default"].shape({
    values: _pt__default["default"].objectOf(_pt__default["default"].node)
  })]),
...
Body.propTypes = process.env.NODE_ENV !== "production" ? {
  as: _pt__default["default"].oneOf(['span', 'p']),
  isBold: _pt__default["default"].bool,
  isItalic: _pt__default["default"].bool,
  isStrikethrough: _pt__default["default"].bool,
  tone: _pt__default["default"].oneOfType([_pt__default["default"].oneOf(['primary', 'secondary', 'tertiary', 'information', 'positive', 'negative', 'critical', 'inherit']), _pt__default["default"].oneOf(['inverted'])]),
  fontWeight: _pt__default["default"].oneOf(['regular', 'medium', 'bold']),
  truncate: _pt__default["default"].bool,
  nowrap: _pt__default["default"].bool,
  id: _pt__default["default"].string,
  intlMessage: _pt__default["default"].oneOfType([_pt__default["default"].any, _pt__default["default"].shape({
...
Detail.propTypes = process.env.NODE_ENV !== "production" ? {
  isBold: _pt__default["default"].bool,
  isItalic: _pt__default["default"].bool,
  isStrikethrough: _pt__default["default"].bool,
  as: _pt__default["default"].oneOf(['span', 'small']),
  tone: _pt__default["default"].oneOfType([_pt__default["default"].oneOf(['primary', 'secondary', 'tertiary', 'information', 'positive', 'negative', 'critical', 'inherit']), _pt__default["default"].oneOf(['warning']), _pt__default["default"].oneOf(['inverted'])]),
  fontWeight: _pt__default["default"].oneOf(['regular', 'medium', 'bold']),
  truncate: _pt__default["default"].bool,
  nowrap: _pt__default["default"].bool,
  'aria-labelledby': _pt__default["default"].string,
  id: _pt__default["default"].string,
  intlMessage: _pt__default["default"].oneOfType([_pt__default["default"].any, _pt__default["default"].shape({
    values: _pt__default["default"].objectOf(_pt__default["default"].node)
  })]),
