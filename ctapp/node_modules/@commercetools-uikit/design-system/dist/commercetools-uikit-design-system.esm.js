...
const ThemeProvider = props => {
  ...
  useLayoutEffect(() => {
    ...
    if (themeNameRef.current !== props.theme || !isEqual(themeOverridesRef.current, props.themeOverrides)) {
...
ThemeProvider.propTypes = {
  parentSelector: _pt.any,
  theme: _pt.string,
  themeOverrides: _pt.objectOf(_pt.string)
};
