...
import { AttributeGroup, AttributeGroupReference, AttributeGroupResourceIdentifier } from "./attribute-group.js";
import { BusinessUnit, BusinessUnitKeyReference, BusinessUnitReference, BusinessUnitResourceIdentifier } from "./business-unit.js";
import { Cart, CartReference, CartResourceIdentifier, DirectDiscountReference } from "./cart.js";
import { CartDiscount, CartDiscountReference, CartDiscountResourceIdentifier } from "./cart-discount.js";
import { Category, CategoryReference, CategoryResourceIdentifier } from "./category.js";
import { Channel, ChannelReference, ChannelResourceIdentifier } from "./channel.js";
...
import { StagedQuote, StagedQuoteReference, StagedQuoteResourceIdentifier } from "./staged-quote.js";
import { StandalonePrice, StandalonePriceReference, StandalonePriceResourceIdentifier } from "./standalone-price.js";
import { State, StateReference, StateResourceIdentifier } from "./state.js";
import { Store, StoreKeyReference, StoreReference, StoreResourceIdentifier } from "./store.js";
...
export type _BaseResource = BaseResource | ApprovalFlow | ApprovalRule | AssociateRole | AttributeGroup | BusinessUnit | Cart | CartDiscount | Category | Channel | CustomObject | Customer | CustomerGroup | DiscountCode | Extension | InventoryEntry | Message | _Order | OrderEdit | Payment | Product | ProductDiscount | ProductProjection | ProductSelection | ProductType | Quote | QuoteRequest | Review | ShippingMethod | ShoppingList | StagedQuote | StandalonePrice | State | Store | Subscription | TaxCategory | Type | Zone;
/**
 ...
 *
 */
export type ResourceIdentifier = AssociateRoleResourceIdentifier | AttributeGroupResourceIdentifier | BusinessUnitResourceIdentifier | CartDiscountResourceIdentifier | CartResourceIdentifier | CategoryResourceIdentifier | ChannelResourceIdentifier | CustomerGroupResourceIdentifier | CustomerResourceIdentifier | DiscountCodeResourceIdentifier | InventoryEntryResourceIdentifier | OrderEditResourceIdentifier | PaymentResourceIdentifier | ProductDiscountResourceIdentifier | ProductResourceIdentifier | ProductSelectionResourceIdentifier | ProductTypeResourceIdentifier | QuoteRequestResourceIdentifier | QuoteResourceIdentifier | ReviewResourceIdentifier | ShippingMethodResourceIdentifier | ShoppingListResourceIdentifier | StagedQuoteResourceIdentifier | StandalonePriceResourceIdentifier | StateResourceIdentifier | StoreResourceIdentifier | TaxCategoryResourceIdentifier | TypeResourceIdentifier | ZoneResourceIdentifier;
/**
