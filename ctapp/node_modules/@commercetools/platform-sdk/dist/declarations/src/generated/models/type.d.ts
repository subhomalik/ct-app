 ...
 *
 */
export type CustomFieldReferenceValue = 'approval-flow' | 'associate-role' | 'business-unit' | 'cart' | 'category' | 'channel' | 'customer' | 'key-value-document' | 'order' | 'product' | 'product-type' | 'review' | 'shipping-method' | 'state' | 'zone' | string;
/**
