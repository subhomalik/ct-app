...
function useAllFeatureToggles() {
  ...
  return adapterContext.adapterEffectIdentifiers.reverse().reduce((_allFlags, adapterIdentifier) => _objectSpread(_objectSpread({}, _allFlags), flagsContext[adapterIdentifier]), {});
}
