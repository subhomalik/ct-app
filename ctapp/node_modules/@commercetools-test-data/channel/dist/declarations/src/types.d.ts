...
import type { TClientLoggingGraphql, TLocalizedStringGraphql } from '@commercetools-test-data/commons';
import type { TBuilder } from '@commercetools-test-data/core';
export type TChannel = Channel;
export type TChannelDraft = ChannelDraft;
export type TChannelDraftGraphql = Omit<TChannelDraft, 'name' | 'description'> & {
    name?: TLocalizedStringGraphql;
    description?: TLocalizedStringGraphql;
};
export type TChannelGraphql = Omit<TChannel, 'name' | 'description' | 'createdBy' | 'lastModifiedBy'> & {
    __typename: 'Channel';
