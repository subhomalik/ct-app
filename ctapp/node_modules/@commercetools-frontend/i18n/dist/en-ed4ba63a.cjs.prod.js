...
var en = {
	...
	"ApiError.DuplicatePriceScope": [
		{
			type: 0,
			value: "A price with the same scope already exists for this product variant. Make sure that the combination of currency, country, customer group, channel and valid dates is unique per price."
		}
	],
	...
	"FailedAuthentication.paragraph1": [
		{
			type: 0,
			value: "Please try again or contact your system administrator if you have any further questions."
		}
	],
	...
	"QuickAccess.openDeveloperSettings": [
		{
			type: 0,
			value: "Open Developer Settings"
		}
	],
	"QuickAccess.openDiscountCodesList": [
		{
			type: 0,
			value: "Open Discount code list"
		}
	],
	...
	"QuickAccess.openManageOrganizations": [
		{
			type: 0,
			value: "Open Manage Organizations"
		}
	],
	"QuickAccess.openManageProject": [
		{
			type: 0,
			value: "Open Manage Projects"
		}
	],
	"QuickAccess.openModifiedProducts": [
		{
			type: 0,
			value: "Open Review Modified Products"
		}
	],
	"QuickAccess.openMyProfile": [
		{
			type: 0,
			value: "Open My Profile"
		}
	],
	...
	"QuickAccess.openOrdersList": [
		{
			type: 0,
			value: "Open Order list"
		}
	],
	"QuickAccess.openPimSearch": [
		{
			type: 0,
			value: "Open PIM Search"
		}
	],
	"QuickAccess.openProductDiscountsList": [
		{
			type: 0,
			value: "Open Product discount list"
		}
	],
	"QuickAccess.openProductList": [
		{
			type: 0,
			value: "Open Product list"
		}
	],
	"QuickAccess.openProductTypesSettings": [
		{
			type: 0,
			value: "Open Product Types Settings"
		}
	],
	...
	"QuickAccess.openProjectSettingsChannelsTab": [
		{
			type: 0,
			value: "Open Project Settings • Channels"
		}
	],
	"QuickAccess.openProjectSettingsInternationalTab": [
		{
			type: 0,
			value: "Open Project Settings • International"
		}
	],
	...
	"QuickAccess.openProjectSettingsTaxesTab": [
		{
			type: 0,
			value: "Open Project Settings • Taxes"
		}
	],
