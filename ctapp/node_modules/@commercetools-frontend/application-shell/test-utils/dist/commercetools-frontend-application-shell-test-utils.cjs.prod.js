...
var applicationEntryPoint = require('../../dist/application-entry-point-bde45acf.cjs.prod.js');
var index = require('../../dist/index-6cd618cc.cjs.prod.js');
...
function createReduxProviders() {
  ...
  !!(store && storeState) ? invariant__default["default"](false) : void 0;
  !!(store && sdkMocks.length > 0) ? invariant__default["default"](false) : void 0;
