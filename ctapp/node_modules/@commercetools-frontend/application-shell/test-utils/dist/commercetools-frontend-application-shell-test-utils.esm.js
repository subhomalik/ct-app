...
import { A as ApplicationEntryPoint } from '../../dist/application-entry-point-3613e4a5.esm.js';
import { c as createReduxStore } from '../../dist/index-89e5711a.esm.js';
...
function _objectSpread$1(e) { for (var r = 1; r < arguments.length; r++) { var _context9, _context10; var t = null != arguments[r] ? arguments[r] : {}; r % 2 ? _forEachInstanceProperty(_context9 = ownKeys$1(Object(t), !0)).call(_context9, function (r) { _defineProperty(e, r, t[r]); }) : _Object$getOwnPropertyDescriptors ? _Object$defineProperties(e, _Object$getOwnPropertyDescriptors(t)) : _forEachInstanceProperty(_context10 = ownKeys$1(Object(t))).call(_context10, function (r) { _Object$defineProperty(e, r, _Object$getOwnPropertyDescriptor(t, r)); }); } return e; }
...
function renderHook(callback) {
  ...
  // eslint-disable-next-line testing-library/render-result-naming-convention
  const rendered = rtlHooks.renderHook(callback, _objectSpread$1(_objectSpread$1({}, options), {}, {
    // eslint-disable-next-line react/display-name
    wrapper: _ref5 => {
...
const hooks = _objectSpread$1(_objectSpread$1({}, rtlHooks), {}, {
  renderHook
});
...
const renderCustomView = props => {
  ...
  return renderApp(jsx(CustomViewContextProvider, {
...
export { denormalizeActionRights, denormalizeDataFences, denormalizePermissions, hooks, mapResourceAccessToAppliedPermissions, renderApp, renderAppWithRedux, renderCustomView };
