...
export declare enum TActionType {
    Create = "Create",
    Update = "Update"
}
...
export declare enum TOrderSearchStatus {
    Activated = "Activated",
    Deactivated = "Deactivated"
}
...
export declare enum TOrderState {
    Cancelled = "Cancelled",
    Complete = "Complete",
    Confirmed = "Confirmed",
    Open = "Open"
...
export declare enum TPaymentState {
...
export declare enum TReturnPaymentState {
    Initial = "Initial",
    NonRefundable = "NonRefundable",
    NotRefunded = "NotRefunded",
    Refunded = "Refunded"
}
export declare enum TReturnShipmentState {
    Advised = "Advised",
...
export declare enum TSearchIndexingStatus {
    Activated = "Activated",
    Deactivated = "Deactivated",
    Indexing = "Indexing"
}
...
export declare enum TStateRole {
    Return = "Return",
    ReviewIncludedInStatistics = "ReviewIncludedInStatistics"
}
export declare enum TStateType {
...
export declare enum TSubscriptionHealthStatus {
...
export declare enum TTransactionState {
    Failure = "Failure",
    Initial = "Initial",
    Pending = "Pending",
    Success = "Success"
}
export declare enum TTransactionType {
