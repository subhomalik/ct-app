      ...
      navBarGroups: menuLinks ? [{
        ...
        items: [{
          ...
          submenu: _mapInstanceProperty__default["default"](_context2 = menuLinks.submenuLinks).call(_context2, submenuLink => {
            ...
            return {
              __typename: 'BaseMenu',
              key: _concatInstanceProperty__default["default"](_context3 = "".concat(entryPointUriPath, "-")).call(_context3, submenuLink.uriPath),
...
function useApplicationsMenu(menuKey, config) {
  ...
  const _useMcQuery = applicationShellConnectors.useMcQuery(FetchApplicationsMenu, {
