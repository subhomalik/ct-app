...
const redirectTo = targetUrl => {
  useIsServedByProxy.location.replace(targetUrl);
};
const useRedirector = () => {
  const redirector = react.useCallback(options => {
    ...
    const targetUrlObject = new _URL__default["default"](originUrl);
...
exports.useRedirector = useRedirector;
