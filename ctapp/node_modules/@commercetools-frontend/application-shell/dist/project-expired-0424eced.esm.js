...
import { S as ServicePageProjectSwitcher } from './service-page-project-switcher-d96a616b.esm.js';
import { jsx } from '@emotion/react/jsx-runtime';
import '@emotion/styled/base';
import 'react-router-dom';
import '@commercetools-frontend/application-shell-connectors';
import './index-fe5ba32e.esm.js';
import 'prop-types';
import 'react';
...
const ProjectExpired = () => {
  ...
  return jsx(MaintenancePageLayout, {
    imageSrc: themedValue(ProjectExpiredIllustration, ProjectExpiredIllustrationRebranding),
    title: jsx(FormattedMessage, _objectSpread({}, messages.title)),
    label: intl.formatMessage(messages.title),
    paragraph1: jsx(FormattedMessage, _objectSpread(_objectSpread({}, messages.paragraph1), {}, {
      values: {
        mailto: jsx(EmailLink, {
          email: salesEmail
        })
      }
    })),
    bodyContent: jsx(ServicePageProjectSwitcher, {})
  });
};
