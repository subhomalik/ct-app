...
const buildOidcScope = options => {
  ...
  if (options.teamId) {
    var _context11;
    claims.push(_concatInstanceProperty__default["default"](_context11 = "".concat(OIDC_CLAIMS.TEAM_ID, ":")).call(_context11, options.teamId));
    if (options.applicationId) {
      var _context12;
      claims.push(_concatInstanceProperty__default["default"](_context12 = "".concat(OIDC_CLAIMS.APPLICATION_ID, ":")).call(_context12, options.applicationId));
    }
  }
  return [
