...
const MenuItem = /*#__PURE__*/_styled__default["default"]("div", {
  target: "e1al5ftg0"
} )("width:100%;cursor:pointer;color:", designSystem.designTokens.colorSolid, ";:hover{background-color:", designSystem.designTokens.colorNeutral95, ";}", props => props.hasDivider === true ? /*#__PURE__*/react$1.css("border-bottom:1px solid ", designSystem.designTokens.colorNeutral, ";margin:", designSystem.designTokens.spacing10, " 0;" + ("" ), "" ) : '', ";" + ("" ));
