...
var ProjectSuspendedSVGRebranding = require('@commercetools-frontend/assets/images/locked-diamond-rebranding.svg');
...
var ProjectSuspendedSVGRebranding__default = /*#__PURE__*/_interopDefault(ProjectSuspendedSVGRebranding);
var ProjectSuspendedSVG__default = /*#__PURE__*/_interopDefault(ProjectSuspendedSVG);
...
const getTitleMessage = props => {
  /* NOTE: Other suspension reasons are `Payment` and `Other` which are not handled yet */
  if (props.isTemporary === true) return messages.temporaryMaintenanceSuspensionMessage;
...
const ProjectSuspended = props => {
  ...
  return jsxRuntime.jsx(applicationComponents.MaintenancePageLayout, {
    imageSrc: themedValue(ProjectSuspendedSVG__default["default"], ProjectSuspendedSVGRebranding__default["default"]),
    title: jsxRuntime.jsx(reactIntl.FormattedMessage, _objectSpread({}, titleMessage)),
...
exports["default"] = ProjectSuspended;
