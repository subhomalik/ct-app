...
const getImportChunk$3 = locale => {
  ...
  switch (intlLocale) {
    ...
    case 'zh-CN':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "country-data-zh-CN" */'./zh-CN-01cbbc4d.cjs.prod.js'); });
    default:
...
const getImportChunk$2 = locale => {
  ...
  switch (intlLocale) {
    ...
    case 'zh-CN':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "currency-data-zh-CN" */'./zh-CN-d221a0e9.cjs.prod.js'); });
    default:
...
const getImportChunk$1 = locale => {
  ...
  switch (intlLocale) {
    ...
    case 'zh-CN':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "language-data-zh-CN" */'./zh-CN-ebd005f5.cjs.prod.js'); });
    default:
...
const getImportChunk = locale => {
  ...
  switch (intlLocale) {
    ...
    case 'zh-CN':
      return Promise.resolve().then(function () { return require( /* webpackChunkName: "timezone-data-zh-CN" */'./zh-CN-770ced57.cjs.prod.js'); });
    default:
