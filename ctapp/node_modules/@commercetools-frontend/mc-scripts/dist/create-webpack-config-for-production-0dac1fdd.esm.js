...
import { c as createPostcssConfig } from './create-postcss-config-0e0c9a5d.esm.js';
...
function createWebpackConfigForProduction() {
  ...
  return {
    ...
    resolve: {
      ...
      extensions: _mapInstanceProperty(_context2 = ['js', 'mjs', 'cjs', 'ts', 'tsx', 'json', 'jsx']).call(_context2, ext => ".".concat(ext)),
          ...
          options: {
            ...
            svgoConfig: {
              ...
              // - And different in different files.
              {
                ...
                params: {
                  delim: '',
                  prefix: (_, info) => "svg".concat(crypto.createHash('shake256', {
                    outputLength: 6
