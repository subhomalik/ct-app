...
var _package = require('../../dist/package-b85a1752.cjs.prod.js');
...
async function run() {
  ...
  cli.command('start', usageStart).usage("\n\n  ".concat(usageStart)).alias('dev').action(async options => {
    ...
    const startCommand = shouldUseExperimentalBundler ? await Promise.resolve().then(function () { return require('../../dist/start-vite-e1f2b31e.cjs.prod.js'); }) : await Promise.resolve().then(function () { return require('../../dist/start-8dfa0096.cjs.prod.js'); });
  ...
  cli.command('build', usageBuild).usage("\n\n  ".concat(usageBuild)).option('--build-only', '(optional) If defined, the command only creates the production bundles without compiling the "index.html".', {
    ...
    const buildCommand = shouldUseExperimentalBundler ? await Promise.resolve().then(function () { return require('../../dist/build-vite-b674f8bd.cjs.prod.js'); }) : await Promise.resolve().then(function () { return require('../../dist/build-6a761dfe.cjs.prod.js'); });
  ...
  cli.command('login', usageLogin).usage("\n\n  ".concat(usageLogin)).action(async options => {
    ...
    // Do this as the first thing so that any code reading it knows the right env.
    process.env.NODE_ENV = 'production';
    const loginCommand = await Promise.resolve().then(function () { return require('../../dist/login-043f8aac.cjs.prod.js'); });
  ...
  cli.command('config:sync', usageConfigSync).usage("\n\n  ".concat(usageConfigSync)).option('--dry-run', '(optional) Executes the command but does not send any mutation request.', {
    ...
    // Do this as the first thing so that any code reading it knows the right env.
    process.env.NODE_ENV = 'production';
    const configSyncCommand = await Promise.resolve().then(function () { return require('../../dist/config-sync-f5c869a2.cjs.prod.js'); });
